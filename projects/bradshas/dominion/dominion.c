...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
		int z;
		z = cardMine(state, currentPlayer, choice1, choice2, handPos);
		return z;
    ...
    case baron:
        cardBaron(state, choice1, currentPlayer);
    ...
    case tribute:
		cardTribute(state, nextPlayer, tributeRevealedCards, currentPlayer);
  
        return 0;

    case ambassador:
		return cardAmbassador(state, handPos, currentPlayer, choice1, choice2);
